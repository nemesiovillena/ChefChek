...
export class RecipesService {
  ...
  async duplicate(
    ...
    const duplicatedRecipe = await this.create(tenantId, {
      ...
      preparationTimeMinutes:
        originalRecipe.preparationTimeMinutes ?? undefined,
      cookingTimeMinutes: originalRecipe.cookingTimeMinutes ?? undefined,
  ...
  private async formatRecipeResponse(
    ...
    const base = {
      ...
      shelfLifeFrozenDays: recipe.shelfLifeFrozenDays ?? null,
      storageCondition: recipe.storageCondition ?? null,
      storageTempMin: recipe.storageTempMin ?? null,
      storageTempMax: recipe.storageTempMax ?? null,
