...
export default function OrdersPage() {
  ...
  const steps = [
    ...
    { title: 'Necesidades', icon: Package },
    { title: 'Por Proveedor', icon: Filter },
    { title: 'Por Zona', icon: AlertCircle },
    { title: 'Pedidos', icon: Clock },
  ];
                ...
                <div className="flex gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <option value="DRY_GOODS">Secos</option>
